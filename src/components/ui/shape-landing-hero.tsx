...
function HeroGeometric({
  ...
  title2 = "e financeiro",
  description = "O app que conecta personal e aluno em uma rotina simples de prescricao, acompanhamento, evolucao, chat e pagamentos.",
  children,
}: {
  badge?: string;
  title1?: string;
  ...
  return (
    <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-[#030303]">
      <div className="absolute inset-0 bg-gradient-to-br from-[#0a84ff]/[0.08] via-transparent to-[#29c76f]/[0.06] blur-3xl" />
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        <div className="mx-auto max-w-4xl text-center">
          ...
          >
            <Circle className="size-2 fill-[#0a84ff] text-[#0a84ff]" />
            <span className="text-sm tracking-wide text-white/64">{badge}</span>
          </motion.div>
          ...
          <motion.div custom={1} variants={fadeUpVariants} initial="hidden" animate="visible">
            <h1 className="mb-6 text-5xl font-bold tracking-tight sm:text-6xl md:mb-8 md:text-8xl">
              ...
              <br />
              <span className="bg-gradient-to-r from-[#7bbcff] via-white/90 to-[#7df0a9] bg-clip-text text-transparent">
                {title2}
              </span>
            </h1>
          </motion.div>
          ...
          <motion.div custom={2} variants={fadeUpVariants} initial="hidden" animate="visible">
            <p className="mx-auto mb-8 max-w-2xl px-4 text-base font-light leading-relaxed tracking-wide text-white/52 sm:text-lg md:text-xl">
              {description}
            </p>
          </motion.div>
