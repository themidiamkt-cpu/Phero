  ...
  return (
    <>
      <button
        type="button"
        onClick={showTour}
        className="pressable fixed bottom-28 right-[calc(50%-13rem)] z-30 grid size-11 place-items-center rounded-full border border-[var(--hair)] bg-[var(--bg)] text-[var(--ink)] shadow-[var(--shadow-card)] backdrop-blur max-[440px]:right-5"
